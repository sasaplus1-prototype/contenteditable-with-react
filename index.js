...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  function App() {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(ContentEditable, {
      key,
      onChange: (event) => {
    ...
    }, "edit1"), /* @__PURE__ */ React.createElement("button", {
      type: "button",
      onClick: () => {
        setKey(String(Math.random()));
        setValue("<b>foo<i>bar<i></b>");
      }
    }, "edit2"), /* @__PURE__ */ React.createElement("button", {
      type: "button",
      onClick: () => {
        setKey(String(Math.random()));
        setValue("<b>foo<i>bar</i>ba</b>z");
      }
    }, "edit3"), /* @__PURE__ */ React.createElement("button", {
      type: "button",
      onClick: () => {
        setTimeout(() => {
          setKey(String(Math.random()));
